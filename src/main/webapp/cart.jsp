                        ...
                        <div class="product" id="product-${cartItem.id}">
                            ...
                            <div class="product-details">
                                ...
                                <div class="quantityControl">
                                    <button type="button" onclick="decrease(${cartItem.id})">-</button>
                                    <input type="text" id="quantity-${cartItem.id}" name="quantity-${cartItem.id}" value="1" readonly>
                                    <button type="button" onclick="increase(${cartItem.id})">+</button>
                                </div>
